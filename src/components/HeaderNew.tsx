...
export const HeaderNew = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-20 bg-gradient-to-r from-blue-600 via-purple-700 to-indigo-800 shadow-lg">


      <div className="max-w-7xl mx-auto px-8 py-4">
        <div className="flex items-center justify-between">
          {/* Logo */}
          <div className="flex items-center space-x-2 text-white cursor-pointer"  onClick={() => navigate("/")}>
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                {!isLoggedIn && (
                  <Button
                    variant="outline"
                    className="border-white/30 text-white hover:bg-white text-purple-900"
                  >
